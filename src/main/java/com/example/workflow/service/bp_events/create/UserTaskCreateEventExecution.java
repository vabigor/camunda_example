...
@Component
public class UserTaskCreateEventExecution implements TaskListener {
    ...
    @Autowired
    public UserTaskCreateEventExecution(DocumentServiceDao documentServiceDao,
    ...
    public void notify(DelegateTask delegateTask) {
        ...
        document.setStatus(DocumentStatus.EXECUTION);
        ...
        processTaskModel.setExecutionCount(1);
        processTaskModel.setType(DocumentStatus.EXECUTION);
        ...
        System.out.println("userTask create EXECUTION");
    }
